...
const BUILTIN_FEISHU_SUMMARY_TEMPLATE = `{{#if summaryTitle}}**{{summaryTitle}}**{{else}}{{#if event.title}}**{{event.title}}**{{else}}{{#if target.displayText}}**{{target.displayText}}**{{/if}}{{/if}}{{/if}}
{{#if target.markdownLink}}
...
const BUILTIN_WECOM_SUMMARY_TEMPLATE = `{{#if summaryTitle}}{{summaryTitle}}{{else}}{{#if event.title}}{{event.title}}{{else}}{{#if target.displayText}}{{target.displayText}}{{/if}}{{/if}}{{/if}}
{{#if target.url}}
