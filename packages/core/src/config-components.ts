...
export const CONFIG_FIELD_INVENTORY: readonly ConfigFieldSpec[] = [
  ...
  g("outputs.channels[].member_directory.cache_ttl_seconds", { t: "ZodNumber", own: "entity", ent: "channel", cap: "feishu_app only; runtime default 300; 0 disables cache", con: "packages/outputs/src/feishu-app.ts", wir: true, ui: "number" }),
