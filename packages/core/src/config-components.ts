...
const REVIEW_TREE: readonly (readonly [string, string, Omit<RowSpec, "t">])[] = [
  ...
  ["max_files", "ZodNumber", { d: 2000, own: "business", wir: true, con: REVIEW_CONSUMER, ui: "number", tid: "H05" }],
  ["max_patch_bytes", "ZodNumber", { d: 20971520, own: "business", wir: true, con: REVIEW_CONSUMER, ui: "number", tid: "H05" }],
...
function workspaceAgentRows(): ConfigFieldSpec[] {
  const fields: readonly (readonly [string, RowSpec])[] = [
    ...
    ["web_search.credentials.*", { t: "union", own: "business", wir: true, ui: "secret-ref", cap: "env var name string or { value } literal" }],
...
function contextRepositoryRows(): ConfigFieldSpec[] {
  ...
  const entries: readonly (readonly [string, string, Omit<RowSpec, "t" | "own" | "wir" | "con">])[] = [
    ...
    ["token", "ZodString", { ui: "secret-value", cap: "git kinds; mutually exclusive with token_env" }],
    ...
    ["user", "ZodString", { ui: "text", cap: "p4 only; mutually exclusive with user_env" }],
    ["ticket_env", "ZodString", { ui: "secret-ref", cap: "p4 only" }],
    ["ticket", "ZodString", { ui: "secret-value", cap: "p4 only; mutually exclusive with ticket_env" }],
    ["password_env", "ZodString", { ui: "secret-ref", cap: "p4 only" }],
    ["password", "ZodString", { ui: "secret-value", cap: "p4 only; mutually exclusive with password_env" }],
...
export const CONFIG_FIELD_INVENTORY: readonly ConfigFieldSpec[] = [
  ...
  g("server.auth.api_key", { t: "ZodString", own: "bootstrap", res: "resolveAuthConfig", con: "packages/server/src/bootstrap.ts:resolveAuthConfig", wir: true, ui: "secret-value", cap: "mutually exclusive with api_key_env" }),
  ...
  g("admin.password", { t: "ZodString", own: "bootstrap", con: "packages/server/src/admin-auth.ts", wir: true, ui: "secret-value", cap: "mutually exclusive with password_env" }),
  g("admin.password_hash", { t: "ZodString", own: "bootstrap", con: "packages/server/src/admin-auth.ts", wir: true, ui: "secret-value", cap: "sha256:<hex>; mutually exclusive with password_hash_env" }),
  ...
  g("llm.providers[].api_key", { t: "ZodString", own: "entity", ent: "provider", con: "packages/server/src/bootstrap.ts:resolveModelProviderFields", wir: true, ui: "secret-value", cap: "mutually exclusive with api_key_env" }),
  ...
  g("llm.providers[].aws_access_key", { t: "ZodUnknown", own: "entity", ent: "provider", ss: "passthrough", cap: "bedrock only; mutually exclusive with aws_access_key_env", con: "packages/server/src/bootstrap.ts:resolveModelProviderFields", wir: true, ui: "secret-value" }),
  g("llm.providers[].aws_secret_key", { t: "ZodUnknown", own: "entity", ent: "provider", ss: "passthrough", cap: "bedrock only; mutually exclusive with aws_secret_key_env", con: "packages/server/src/bootstrap.ts:resolveModelProviderFields", wir: true, ui: "secret-value" }),
  g("llm.providers[].aws_session_token", { t: "ZodUnknown", own: "entity", ent: "provider", ss: "passthrough", cap: "bedrock only; mutually exclusive with aws_session_token_env", con: "packages/server/src/bootstrap.ts:resolveModelProviderFields", wir: true, ui: "secret-value" }),
  g("llm.providers[].google_application_credentials", { t: "ZodUnknown", own: "entity", ent: "provider", ss: "passthrough", cap: "vertex_ai only; mutually exclusive with google_application_credentials_env", con: "packages/server/src/bootstrap.ts:resolveModelProviderFields", wir: true, ui: "secret-value" }),
  ...
  g("llm.author_resolution_model_chain", { t: "ZodString", own: "business", res: "resolveAuthorModelChainName", con: "packages/server/src/bootstrap.ts:resolveAuthorModelChainName", wir: true, ui: "select" }),
  ...
  g("triggers[].app.private_key_env", { t: "ZodString", own: "entity", ent: "trigger", cap: "github only; mutually exclusive with private_key_path/private_key", con: "packages/server/src/github-app-token.ts:resolveGithubAppTriggerAuth", wir: true, ui: "secret-ref" }),
  g("triggers[].app.private_key", { t: "ZodString", own: "entity", ent: "trigger", cap: "github only; mutually exclusive with private_key_env/private_key_path", con: "packages/server/src/github-app-token.ts:resolveGithubAppTriggerAuth", wir: true, ui: "secret-value" }),
  ...
  g("triggers[].token", { t: "ZodString", own: "entity", ent: "trigger", cap: "git kinds outbound auth; mutually exclusive with token_env and app", con: "packages/server/src/bootstrap.ts:buildWebhookConfigFromTrigger", wir: true, ui: "secret-value" }),
  ...
  g("triggers[].webhook_secret", { t: "ZodString", own: "entity", ent: "trigger", cap: "git kinds inbound signature; mutually exclusive with webhook_secret_env", con: "packages/server/src/webhook-common.ts:verifyWebhookSignature", wir: true, ui: "secret-value" }),
  ...
  g("triggers[].user", { t: "ZodString", own: "entity", ent: "trigger", cap: "p4 only; mutually exclusive with user_env", con: "packages/server/src/bootstrap.ts:resolveP4TriggerConfig", wir: true, ui: "text" }),
  ...
  g("triggers[].ticket", { t: "ZodString", own: "entity", ent: "trigger", cap: "p4 only; mutually exclusive with ticket_env", con: "packages/server/src/bootstrap.ts:resolveP4TriggerConfig", wir: true, ui: "secret-value" }),
  ...
  g("triggers[].password", { t: "ZodString", own: "entity", ent: "trigger", cap: "p4/svn; mutually exclusive with password_env", con: "packages/server/src/bootstrap.ts:resolveP4TriggerConfig", wir: true, ui: "secret-value" }),
  g("triggers[].username", { t: "ZodString", own: "entity", ent: "trigger", cap: "svn only; mutually exclusive with username_env", con: "packages/server/src/bootstrap.ts svn trigger resolver", wir: true, ui: "text" }),
  ...
  g("outputs.author_resolution.directory_cache_ttl_seconds", { t: "ZodNumber", own: "business", res: "resolveChannelDirectoryCacheTtlSeconds", con: "packages/outputs/src/channel-identity.ts:resolveChannelDirectoryCacheTtlSeconds", wir: true, ui: "number", cap: "global directory snapshot TTL; channel member_directory.cache_ttl_seconds wins; runtime default 43200 (12h); 0 disables cache; max 604800 (7d)" }),
  ...
  g("outputs.channels[].kind", { t: "ZodString", own: "entity", ent: "channel", cap: "built-in kinds validated by config-capabilities", con: "packages/server/src/bootstrap.ts:createChannelPublisherFromConfig", wir: true, ui: "select" }),
  g("outputs.channels[].app_id", { t: "ZodString", own: "entity", ent: "channel", cap: "feishu_app only", con: "packages/outputs/src/feishu-app.ts", wir: true, ui: "text" }),
  g("outputs.channels[].app_secret", { t: "ZodString", own: "entity", ent: "channel", cap: "feishu_app only; mutually exclusive with app_secret_env", con: "packages/outputs/src/feishu-app.ts", wir: true, ui: "secret-value" }),
  g("outputs.channels[].app_secret_env", { t: "ZodString", own: "entity", ent: "channel", cap: "feishu_app only", con: "packages/outputs/src/feishu-app.ts", wir: true, ui: "secret-ref" }),
  g("outputs.channels[].receive_id", { t: "ZodString", own: "entity", ent: "channel", cap: "feishu_app only", con: "packages/outputs/src/feishu-app.ts", wir: true, ui: "text" }),
  ...
  g("outputs.channels[].guess_author", { t: "ZodBoolean", own: "entity", ent: "channel", cap: "feishu_app only; runtime default true; requires mention_author and directory for model fallback", con: "packages/outputs/src/channel-identity.ts", wir: true, ui: "toggle" }),
  ...
  g("outputs.channels[].label_ids", { t: "ZodNumber[]", own: "entity", ent: "channel", cap: "gitea_problem_issue only; unread on github_problem_issue/gitlab_problem_issue", con: "packages/server/src/bootstrap.ts:createGiteaProblemIssueDispatcher", wir: true, ui: "multiselect" }),
  g("outputs.channels[].labels", { t: "ZodString[]", own: "entity", ent: "channel", cap: "github_problem_issue/gitlab_problem_issue only; unread on gitea_problem_issue", con: "packages/server/src/bootstrap.ts:createGithubProblemIssueDispatcher createGitlabProblemIssueDispatcher", wir: true, ui: "multiselect" }),
  ...
  g("outputs.channels[].issue_link_card", { t: "ZodEnum", own: "entity", ent: "channel", cap: "feishu_bot/feishu_app only; card content level when a managed-issue detail link exists; runtime default titles", con: "packages/server/src/bootstrap.ts feishu dispatchers", wir: true, ui: "select" }),
  g("outputs.channels[].resolved_action", { t: "ZodEnum", own: "entity", ent: "channel", cap: "delete is gitea_problem_issue/gitlab_problem_issue only", con: "packages/server/src/bootstrap.ts problem issue dispatchers", wir: true, ui: "select" }),
  ...
  g("outputs.channels[].notify_feishu.webhook_url", { t: "ZodString", own: "entity", ent: "channel", cap: "problem issue kinds; mutually exclusive with webhook_url_env", con: "packages/server/src/bootstrap.ts problem issue dispatchers", wir: true, ui: "secret-value" }),
  ...
  g("outputs.channels[].notify_feishu.secret", { t: "ZodString", own: "entity", ent: "channel", cap: "problem issue kinds; mutually exclusive with secret_env", con: "packages/server/src/bootstrap.ts problem issue dispatchers", wir: true, ui: "secret-value" }),
  ...
  g("outputs.channels[].token", { t: "ZodString", own: "entity", ent: "channel", cap: "mutually exclusive with token_env", con: "packages/server/src/bootstrap.ts channel token override", wir: true, ui: "secret-value" }),
  ...
  g("outputs.channels[].webhook_url", { t: "ZodString", own: "entity", ent: "channel", cap: "feishu_bot/wecom_bot; mutually exclusive with webhook_url_env", con: "packages/server/src/bootstrap.ts bot dispatchers", wir: true, ui: "secret-value" }),
  ...
  g("outputs.channels[].secret", { t: "ZodString", own: "entity", ent: "channel", cap: "feishu_bot only; mutually exclusive with secret_env", con: "packages/server/src/bootstrap.ts:createFeishuBotDispatcher", wir: true, ui: "secret-value" }),
  ...
  g("outputs.channels[].project_id", { t: "ZodUnknown", own: "entity", ent: "channel", ss: "passthrough", cap: "gitlab_mr_review/gitlab_problem_issue only", con: "packages/server/src/bootstrap.ts gitlab dispatchers", wir: true, ui: "text" }),
  ...
  g("agent.web_search.credentials.*", { t: "union", own: "business", con: "packages/agents/src/web-search.ts", wir: true, ui: "secret-ref", cap: "env var name string or { value } literal" }),
  ...
  row("workspaces.defaults.author_resolution_model_chain", DEFAULTS_ONLY, "llm.author_resolution_model_chain", { t: "ZodString", own: "business", res: "resolveAuthorModelChainName", con: "packages/server/src/bootstrap.ts:resolveAuthorModelChainName", wir: true, ui: "select" }),
  ...
  row("workspaces.instances.*.author_resolution_model_chain", WORKSPACE_ONLY, "llm.author_resolution_model_chain", { t: "ZodString", own: "entity", ent: "workspace", res: "resolveAuthorModelChainName", con: "packages/server/src/bootstrap.ts:resolveAuthorModelChainName", wir: true, ui: "select" }),
