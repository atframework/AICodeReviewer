...
export const CHANNEL_KIND_FIELDS: Readonly<Record<string, FieldMap>> = {
  ...
  gitlab_problem_issue: { ...CHANNEL_COMMON_PASSTHROUGH_FIELDS, labels: stringArray },
...
export const CHANNEL_DECLARED_KIND_FIELDS: Readonly<Record<string, readonly string[]>> = {
  ...
  add_owners_as_assignees: ["github_problem_issue", "gitlab_problem_issue", "gitea_problem_issue"],
  notify_feishu: ["github_problem_issue", "gitlab_problem_issue", "gitea_problem_issue"],
  labels: ["github_problem_issue", "gitlab_problem_issue"],
...
export const CHANNEL_RESOLVED_ACTION_VALUES: Readonly<Record<string, readonly string[]>> = {
  ...
  gitlab_problem_issue: ["none", "close", "mark_resolved", "delete"],
