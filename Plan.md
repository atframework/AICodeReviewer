...
[M20](docs/ai/milestones/M20.md)。下一步推进 P7–P8。
...
| 优先级 | 工作 | 本地产物与验收 | 边界 |
| --- | --- | --- | --- |
| P0 | Workspace 多工程规则与动态配置管理 | 管理 UI 已交付；推进多副本完整故障矩阵与整体验收 | P0–P6 已交付；跨版本进程验收与文档收官见 P7–P8 |
...
管理表单（P6）及其审查修复见 M20；后续交付为完整故障矩阵（P7）和整体验收（P8）。
