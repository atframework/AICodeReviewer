...
| ---- | ----------------------------------- | --------------------------------- | ----------------- |
| 1    | `.zhipu.baseURL`                    | `.zhipu.token`                    | `glm-5.1`         |
| 2    | `.kimi_coding.baseURL`              | `.kimi_coding.token`              | `kimi-for-coding` |
| 3    | `.aliyun_coding_plan.baseURL`       | `.aliyun_coding_plan.token`       | `glm-5`           |
| 4    | `.tencentcloud_coding_plan.baseURL` | `.tencentcloud_coding_plan.token` | `glm-5`           |
| 5    | `.aliyun_coding_plan.baseURL`       | `.aliyun_coding_plan.token`       | `kimi-k2.5`       |
| 6    | `.tencentcloud_coding_plan.baseURL` | `.tencentcloud_coding_plan.token` | `kimi-k2.5`       |
| 7    | `.aliyun_coding_plan.baseURL`       | `.aliyun_coding_plan.token`       | `qwen3.6-plus`    |
...
- SSH 用户：`tools`
- SSH 端口：`36000`
- SSH key：`C:/workspace/keys/id_ed25519.vr-cn2.deploy`
