...
export default defineConfig({
  ...
  integrations: [
    starlight({
      ...
      sidebar: [
        {
          ...
          items: [
            ...
            {
              slug: "start/docker-compose",
              translations: { "zh-CN": "Docker Compose 部署" },
            },
            {
              slug: "start/first-webhook",
              translations: { "zh-CN": "第一个 Webhook 评审" },
            },
            {
              slug: "start/dry-run",
              translations: { "zh-CN": "Dry-run 评审" },
            },
            {
              slug: "start/dashboard",
              translations: { "zh-CN": "Dashboard 与日志" },
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              translations: { "zh-CN": "配置总览" },
            },
            {
              slug: "configuration/authentication",
              translations: { "zh-CN": "认证与密钥" },
            },
            {
              slug: "configuration/llm",
              translations: { "zh-CN": "LLM 提供商与模型" },
            },
            {
              slug: "configuration/agent",
              translations: { "zh-CN": "Agent 与沙箱" },
            },
            {
              slug: "configuration/outputs",
              translations: { "zh-CN": "输出通道与路由" },
            },
            {
              slug: "configuration/storage",
              translations: { "zh-CN": "存储" },
            },
            {
              slug: "configuration/queue",
              translations: { "zh-CN": "队列与重试" },
            },
          ],
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              translations: { "zh-CN": "Podman / Rootless" },
            },
            {
              slug: "deployment/operations",
              translations: { "zh-CN": "运维与安全" },
            },
          ],
        },
        {
          ...
          items: [
            {
              slug: "integrations/vcs-providers",
              translations: { "zh-CN": "VCS 提供商" },
            },
            {
              slug: "integrations/agent-adapters",
              translations: { "zh-CN": "Agent 适配器" },
            },
            {
              slug: "integrations/output-channels",
              translations: { "zh-CN": "输出通道" },
            },
            {
              slug: "integrations/im-bots",
              translations: { "zh-CN": "IM 机器人" },
            },
            {
              slug: "integrations/mcp-tools",
              translations: { "zh-CN": "MCP 工具" },
            },
          ],
        },
        {
          ...
          items: [
            ...
            {
              slug: "reference/config-fields",
              translations: { "zh-CN": "配置字段参考" },
            },
            {
              slug: "reference/template-variables",
              translations: { "zh-CN": "模板变量" },
            },
          ],
        },
        {
      ...
      // Load brand webfonts per locale (Latin-only for English, CJK from a
      // China-friendly CDN for Simplified Chinese). See src/components/Head.astro.
      components: {
